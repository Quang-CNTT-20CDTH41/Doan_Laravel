                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            ...
                            <input type="hidden" name="image_list" id="image_list" value="{{ $product->image_list }}">
                        </div>
                        <div class="product__details__pic__slider owl-carousel" id="show_image_list">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__quantity">
                            ...
                            <form action="{{ route('shop_details.store', $product->id) }}" method="post">
                                @csrf
                                <div class="quantity">
                                    <div class="pro-qty">
    ...
    <script>
        ...
        if (_links) {
            ...
            _arrs.forEach(element => {
                let _url = element;
                // console.log(_url);
                _html += '<img data-imgbigurl="' + _url + '" src="' + _url + '" alt="">';
            });
        } else {
            _html += '<img data-imgbigurl="' + _links + '" src="' + _links + '" alt="">';
        }
